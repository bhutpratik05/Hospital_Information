...
<!-- Mirrored from shreethemes.in/doctris/admin/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 04 Mar 2021 02:25:15 GMT -->
<head>
        <meta charset="utf-8" />
            ...
            <nav id="sidebar" class="sidebar-wrapper">
                <div class="sidebar-content" data-simplebar style="height: calc(100% - 60px);">
                    <div class="sidebar-brand">
                        <a href="#"><img src="images/logo-dark.png" height="22" alt=""></a>
                    </div>
                ...
                <ul class="sidebar-footer list-unstyled mb-0">
                    ...
                    <li class="list-inline-item mb-0 ms-1">
                        <div class="dropdown dropdown-primary">
                            <button type="button" class="btn btn-pills btn-soft-primary dropdown-toggle p-0" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><img src="images/language/american.png" class="avatar avatar-ex-small rounded-circle" alt=""></button>
...
<!-- Mirrored from shreethemes.in/doctris/admin/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 04 Mar 2021 02:25:57 GMT -->
</html>